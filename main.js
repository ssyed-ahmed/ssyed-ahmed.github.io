...
var ChartsService = /** @class */ (function () {
    function ChartsService(http) {
        this.http = http;
        this.url = '/assets/data/charts-data.json';
    }
    ChartsService.prototype.getChartData = function () {
...
/* harmony import */ var _charts_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../charts.service */ "./src/app/charts.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var StatisticsComponent = /** @class */ (function () {
    function StatisticsComponent(chartsService) {
    ...
    StatisticsComponent.prototype.loadChart = function () {
        ...
        this.chartsService.getChartData()
            ...
            data.results.forEach(function (obj) {
                _this.month.push(obj.month);
                _this.price.push(obj.price);
                _this.chart = new chart_js__WEBPACK_IMPORTED_MODULE_1__["Chart"]('canvas', {
                    type: 'line',
                    data: {
                        labels: _this.month,
                        datasets: [
    ...
    StatisticsComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_charts_service__WEBPACK_IMPORTED_MODULE_2__["ChartsService"]])
    ], StatisticsComponent);
