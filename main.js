...
/* harmony import */ var src_app_heroes_heroes_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! src/app/heroes/heroes.component */ "./src/app/heroes/heroes.component.ts");
...
/* harmony import */ var src_app_hero_detail_hero_detail_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! src/app/hero-detail/hero-detail.component */ "./src/app/hero-detail/hero-detail.component.ts");
...
var routes = [
    ...
    { path: 'logs', component: src_app_logs_logs_component__WEBPACK_IMPORTED_MODULE_5__["LogsComponent"] },
    { path: 'statistics', component: src_app_statistics_statistics_component__WEBPACK_IMPORTED_MODULE_7__["StatisticsComponent"] },
...
var AppComponent = /** @class */ (function () {
    function AppComponent(communicationService) {
    ...
    AppComponent.prototype.restoreHeroes = function () {
...
/* harmony import */ var _heading_title_directive__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./heading-title.directive */ "./src/app/heading-title.directive.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [
                ...
                _heading_title_directive__WEBPACK_IMPORTED_MODULE_20__["HeadingTitleDirective"]
            ],
            imports: [
...
module.exports = "<div class=\"row\">\r\n  <div class=\"col-sm-12\">\r\n    <div class=\"section\">\r\n      <div class=\"section-header\">\r\n        <div class=\"row\">\r\n          <div class=\"col-sm-12\" appHeadingTitle>\r\n            {{title}}\r\n          </div>\r\n        </div>\r\n      </div>\r\n      <div class=\"section-body\">\r\n        <div class=\"hero-card-container\">\r\n            <div *ngFor=\"let hero of heroes\" [class.hero-card-selected]=\"isSelected(hero)\" routerLink=\"/heroes/{{hero.id}}/dashboard\" class=\"hero-card\" style=\"width: 18rem;\">\r\n              <img class=\"card-img-top image-size\" src=\"./../../assets/{{hero.icon | lowercase}}.png\" alt=\"Card image cap\">\r\n              <div class=\"card-body\">\r\n                <hr>\r\n                <div class=\"row\">\r\n                  <div class=\"col-sm-12 text-center hero-card-title\">\r\n                      {{hero.name}}\r\n                  </div>\r\n                </div>\r\n                <div class=\"row\">\r\n                  <div class=\"col-sm-7\">\r\n                      Rating:\r\n                  </div>\r\n                  <div class=\"col-sm-5\">\r\n                      <span *ngFor=\"let num of hero.rating\">\r\n                        <i class=\"fas fa-star rating-style\"></i>\r\n                      </span>\r\n                  </div>\r\n                </div>\r\n              </div>\r\n            </div>\r\n        </div>\r\n      </div>\r\n    </div>    \r\n  </div>\r\n</div>\r\n"
...
var DashboardComponent = /** @class */ (function () {
    function DashboardComponent(heroService, messageService, communicationService, route) {
        var _this = this;
    ...
    DashboardComponent.prototype.getHeroes = function () {
        ...
        var message = new _message__WEBPACK_IMPORTED_MODULE_3__["Message"]('Fetched heroes in dashboard.', _message__WEBPACK_IMPORTED_MODULE_3__["Severity"].INFO, new Date(), null);
        this.messageService.add(message);
    };
    DashboardComponent.prototype.restoreHeroes = function () {
        this.heroes = _mock_heroes__WEBPACK_IMPORTED_MODULE_5__["HEROES"];
    };
    DashboardComponent.prototype.isSelected = function (hero) {
...
/***/ "./src/app/heading-title.directive.ts":
/*!********************************************!*\
  !*** ./src/app/heading-title.directive.ts ***!
  \********************************************/
/*! exports provided: HeadingTitleDirective */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "HeadingTitleDirective", function() { return HeadingTitleDirective; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
var HeadingTitleDirective = /** @class */ (function () {
    function HeadingTitleDirective(el) {
        this.el = el;
...
var HeroDetailCrimessolvedStatsComponent = /** @class */ (function () {
    function HeroDetailCrimessolvedStatsComponent(route, heroService, communicationService) {
        ...
        this.lineChart = [];
        this.pieChart = [];
        this.pieColors = ['Red', 'Blue', 'Green', 'Yellow', 'Orange', 'Purple', 'Black', 'brown', 'aqua', 'gray', 'crimson', 'violet'];
    ...
    HeroDetailCrimessolvedStatsComponent.prototype.drawPieChart = function () {
        var max = 30;
        var pieArray = this.chartData.map(function (currentValue) {
...
var HeroDetailComponent = /** @class */ (function () {
    ...
    HeroDetailComponent.prototype.goBack = function () {
        // this.location.back();
        var selectedId = this.heroId ? this.heroId : null;
...
/* harmony import */ var src_app_message__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! src/app/message */ "./src/app/message.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var HeroService = /** @class */ (function () {
    ...
    HeroService.prototype.getHeroes = function () {
        ...
        return this.http.get(this.heroesUrl)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(this.handleError('getHeroes', [])));
    };
    HeroService.prototype.log = function (message) {
        var msg = new src_app_message__WEBPACK_IMPORTED_MODULE_6__["Message"]("HeroService " + message, src_app_message__WEBPACK_IMPORTED_MODULE_6__["Severity"].INFO, new Date(), null);
    ...
    HeroService.prototype.getHero = function (id) {
        ...
        return this.http.get(url)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["tap"])(function (_) { return _this.log("fetched hero id=" + id); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(this.handleError("getHero id=" + id)));
    };
    HeroService.prototype.updateHero = function (hero) {
        ...
        return this.http.put(this.heroesUrl, hero, httpOptions)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["tap"])(function (_) { return _this.log("updated hero id=" + hero.id); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(this.handleError("update hero")));
    };
    HeroService.prototype.addHero = function (hero) {
        ...
        return this.http.post(this.heroesUrl, hero, httpOptions)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["tap"])(function (hero) {
            _this.log("added hero with id=" + hero.id);
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(this.handleError('addHero')));
    };
    ...
    HeroService.prototype.searchHeroes = function (term) {
        ...
        return this.http.get(this.heroesUrl + "/?name=" + term)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["tap"])(function (_) { return _this.log("found heroes matching \"" + term + "\""); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(this.handleError("searchHeroes", [])));
    };
    HeroService.prototype.restoreHeroes = function () {
...
var HeroesComponent = /** @class */ (function () {
    function HeroesComponent(heroService, router, communicationService, route) {
        var _this = this;
        this.heroService = heroService;
        this.router = router;
        this.communicationService = communicationService;
        ...
        this.sortDescAscending = true;
        this.sortRatingAscending = true;
        this.heroModel = new _hero__WEBPACK_IMPORTED_MODULE_1__["Hero"](1, '', 'default', '', 'Male', Array(1));
        // Subscribe to the app component messages
        this.subscription = this.communicationService.getMessage().subscribe(function (message) {
            if (message.text === 'restore heroes') {
                _this.restoreHeroes();
    ...
    HeroesComponent.prototype.selectHero = function (id, fromState) {
        this.router.navigate([id, fromState], { relativeTo: this.route });
    };
    HeroesComponent.prototype.addHero = function () {
        var _this = this;
        var newHero = new _hero__WEBPACK_IMPORTED_MODULE_1__["Hero"](this.heroModel.id, this.heroModel.name, 'default', this.heroModel.description, this.heroModel.sex, Array(2));
        this.heroService.addHero(newHero)
            .subscribe(function (hero) {
            _this.heroes.push(hero);
            // Reset the heroModel
            _this.heroModel = new _hero__WEBPACK_IMPORTED_MODULE_1__["Hero"](1, '', 'default', '', 'Male', Array(2));
        });
    };
    HeroesComponent.prototype.launchEditHero = function (hero) {
        this.heroToEdit = hero;
    };
    HeroesComponent.prototype.editHero = function () {
        var _this = this;
        this.heroService.updateHero(this.heroToEdit)
            .subscribe(function () {
            // Reset the flag
            _this.heroToEdit = null;
        });
    };
    HeroesComponent.prototype.deleteHero = function (hero) {
        this.heroToDelete = hero;
    };
    HeroesComponent.prototype.deleteHeroConfirmed = function () {
        var _this = this;
        if (this.heroToDelete) {
            this.heroes = this.heroes.filter(function (h) { return h !== _this.heroToDelete; });
            this.heroService.deleteHero(this.heroToDelete).subscribe();
        }
    };
    HeroesComponent.prototype.restoreHeroes = function () {
        this.heroes = this.heroService.restoreHeroes();
    };
    HeroesComponent.prototype.isSelected = function (hero) {
        return hero.id === this.selectedId;
    };
    HeroesComponent.prototype.validateIdDuplicate = function (value) {
        var isPresent = false;
    ...
    HeroesComponent.prototype.validateIdRange = function (value) {
    ...
    HeroesComponent.prototype.sortByName = function () {
        var _this = this;
        this.sortNameAscending = !this.sortNameAscending;
        this.heroes.sort(function (a, b) {
            var sortNum = a.name < b.name ? -1 : a.name > b.name ? 1 : 0;
            if (!_this.sortNameAscending) {
                sortNum = -sortNum;
            }
            return sortNum;
        });
    };
    HeroesComponent.prototype.sortByDescription = function () {
        var _this = this;
        this.sortDescAscending = !this.sortDescAscending;
        this.heroes.sort(function (a, b) {
            var sortNum = a.description < b.description ? -1 : a.description > b.description ? 1 : 0;
            if (!_this.sortDescAscending) {
                sortNum = -sortNum;
            }
            return sortNum;
        });
    };
    HeroesComponent.prototype.sortByRating = function () {
        var _this = this;
        this.sortRatingAscending = !this.sortRatingAscending;
        this.heroes.sort(function (a, b) {
            var sortNum = a.rating.length - b.rating.length;
            if (!_this.sortRatingAscending) {
                sortNum = -sortNum;
            }
            return sortNum;
        });
    ...
    HeroesComponent = __decorate([
        ...
        __metadata("design:paramtypes", [src_app_hero_service__WEBPACK_IMPORTED_MODULE_2__["HeroService"],
...
module.exports = ".hero-card-container {\r\n    width: 100%;\r\n    overflow-wrap: break-word;\r\n}\r\n.hero-card {\r\n    float: left;\r\n    width: 220px;\r\n    height: 300px;\r\n    border: 1px solid #ccc;\r\n    padding: 10px;\r\n    margin: 10px;\r\n}\r\n.hero-card:hover {\r\n    float: left;\r\n    width: 220px;\r\n    height: 300px;\r\n    border: 1px solid gold;\r\n    padding: 10px;\r\n    margin: 10px;\r\n    background-color: #888;\r\n    left: .1em;\r\n}\r\n.image-size {\r\n    display: block;\r\n    max-width: 230px;\r\n    max-height: 200px;\r\n    width: auto;\r\n    height: auto;\r\n    margin-top: 10px;\r\n}\r\n.section {\r\n    width: 100%;\r\n    height: 100%;\r\n    border: 1px solid #ccc;\r\n}\r\n.section-header {\r\n    height: 60px;\r\n    background-color: crimson;\r\n    color: #fff;\r\n    padding: 10px;\r\n    line-height: 40px;\r\n}\r\n.section-body {\r\n    padding-top: 20px;\r\n    padding-left: 10px;\r\n}\r\n.section-title {\r\n    padding-left: 25px;\r\n    font-size: 1.25rem;\r\n}\r\n.info-style {\r\n    color: blue;\r\n}\r\n.warn-style {\r\n    color: orange;\r\n}\r\n.debug-style {\r\n    color: green;\r\n}\r\n.error-style {\r\n    color: red;\r\n}\r\n.fatal-style {\r\n    color: black;\r\n}"
...
module.exports = "<div class=\"row\">\r\n  <div class=\"col-sm-12\">\r\n      <div class=\"section\">\r\n        <div class=\"section-header\">\r\n          <div class=\"row\">\r\n            <div class=\"col-sm-12\" appHeadingTitle>\r\n              {{title}}\r\n            </div>\r\n          </div>\r\n        </div>\r\n        <div class=\"section-body\">              \r\n          <table class=\"table table-striped\">\r\n            <thead>\r\n              <tr>\r\n                <td>No.</td>\r\n                <td>Type</td>\r\n                <td>Message</td>\r\n                <td>Time</td>\r\n                <td>Stack trace</td>\r\n              </tr> \r\n            </thead>\r\n            <tbody>\r\n              <tr *ngFor=\"let message of messages; index as i\">\r\n                <td>{{i+1}}</td>\r\n                <td>\r\n                  <div [ngSwitch]=\"message.severity\">\r\n                    <div *ngSwitchCase=\"'0'\"><i class=\"fas fa-info-circle info-style\"></i> Info</div>\r\n                    <div *ngSwitchCase=\"'1'\"><i class=\"fas fa-exclamation-triangle warn-style\"></i> Warning</div>\r\n                    <div *ngSwitchCase=\"'2'\"><i class=\"fas fa-bug debug-style\"></i> Debug</div>\r\n                    <div *ngSwitchCase=\"'3'\"><i class=\"fas fa-times-circle error-style\"></i> Error</div>\r\n                    <div *ngSwitchCase=\"'4'\"><i class=\"fas fa-skull fatal-style\"></i> Fatal</div>\r\n                  </div>\r\n                </td>\r\n                <td>{{message.message}}</td>\r\n                <td>{{message.timestamp | date: 'medium'}}</td>\r\n                <td>{{message.stackTrace}}</td>\r\n              </tr>\r\n            </tbody>\r\n          </table>\r\n        </div>\r\n      </div>\r\n  </div>\r\n</div>\r\n\r\n"
...
var LogsComponent = /** @class */ (function () {
    function LogsComponent(messageService) {
        this.messageService = messageService;
        this.title = 'Logs';
    }
    ...
    LogsComponent.prototype.loadMessages = function () {
...
var MessageService = /** @class */ (function () {
    function MessageService() {
        this.messages = this.getDummyMessages();
    }
    ...
    MessageService.prototype.getDummyMessages = function () {
        var messages = [];
        var msg = new _message__WEBPACK_IMPORTED_MODULE_1__["Message"]('This is an info message', _message__WEBPACK_IMPORTED_MODULE_1__["Severity"].INFO, new Date(), null);
        messages.push(msg);
        msg = new _message__WEBPACK_IMPORTED_MODULE_1__["Message"]('This is a warning message', _message__WEBPACK_IMPORTED_MODULE_1__["Severity"].WARNING, new Date(), null);
        messages.push(msg);
        msg = new _message__WEBPACK_IMPORTED_MODULE_1__["Message"]('This is a debug message', _message__WEBPACK_IMPORTED_MODULE_1__["Severity"].DEBUG, new Date(), null);
        messages.push(msg);
        msg = new _message__WEBPACK_IMPORTED_MODULE_1__["Message"]('This is an error message', _message__WEBPACK_IMPORTED_MODULE_1__["Severity"].ERROR, new Date(), null);
        messages.push(msg);
        msg = new _message__WEBPACK_IMPORTED_MODULE_1__["Message"]('This is a fatal message', _message__WEBPACK_IMPORTED_MODULE_1__["Severity"].FATAL, new Date(), null);
        messages.push(msg);
        return messages;
    };
...
/*!****************************!*\
  !*** ./src/app/message.ts ***!
  \****************************/
/*! exports provided: Message, Severity */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var Message = /** @class */ (function () {
    function Message(message, severity, timestamp, stackTrace) {
...
/* harmony import */ var _hero__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./hero */ "./src/app/hero.ts");

var HEROES = [
    new _hero__WEBPACK_IMPORTED_MODULE_0__["Hero"](11, 'Antman', 'antman', 'This is ant man.', 'Male', Array(3)),
    new _hero__WEBPACK_IMPORTED_MODULE_0__["Hero"](12, 'Batman', 'batman', 'This is bat man.', 'Male', Array(4)),
    new _hero__WEBPACK_IMPORTED_MODULE_0__["Hero"](13, 'Hulk', 'hulk', 'This is hulk.', 'Male', Array(5)),
    new _hero__WEBPACK_IMPORTED_MODULE_0__["Hero"](14, 'Ironman', 'ironman', 'This is iron man.', 'Male', Array(4)),
    new _hero__WEBPACK_IMPORTED_MODULE_0__["Hero"](15, 'Spiderman', 'spiderman', 'This is spider man.', 'Male', Array(5)),
    new _hero__WEBPACK_IMPORTED_MODULE_0__["Hero"](16, 'Superman', 'superman', 'This is super man.', 'Male', Array(5)),
    new _hero__WEBPACK_IMPORTED_MODULE_0__["Hero"](17, 'Wonderwoman', 'wonderwoman', 'This is wonder woman.', 'Female', Array(3)),
    new _hero__WEBPACK_IMPORTED_MODULE_0__["Hero"](18, 'Green lantern', 'greenlantern', 'This is green lantern.', 'Male', Array(3)),
    new _hero__WEBPACK_IMPORTED_MODULE_0__["Hero"](19, 'Mocking bird', 'mockingbird', 'This is mocking bird.', 'Female', Array(3)),
    new _hero__WEBPACK_IMPORTED_MODULE_0__["Hero"](20, 'Black widow', 'blackwidow', 'This is black widow.', 'Female', Array(4)),
    new _hero__WEBPACK_IMPORTED_MODULE_0__["Hero"](21, 'New hero', 'default', 'This is default hero.', 'Male', Array(2))
];
...
module.exports = "<div class=\"row\">\n  <div class=\"col-sm-12\">\n    <div class=\"section\">\n      <div class=\"section-header\">\n        <div class=\"row\">\n          <div class=\"col-sm-12 section-title\">\n            {{title}}\n          </div>\n        </div>\n      </div>\n      <div class=\"section-body\">\n        <div class=\"row\">\n          <div class=\"col-sm-12\">\n            <!-- <div *ngIf=\"barChart\">\n              <canvas id=\"canvas\">{{ barChart }}</canvas>\n            </div> -->\n            <div class=\"chart-style\">\n              <div [hidden]=\"!barChart\" class=\"chart-container\">\n                <canvas id=\"barCanvas\">\n                  {{ barChart }}\n                </canvas>\n              </div>        \n            </div>\n          </div>\n        </div>\n      </div>\n    </div>\n  </div>\n</div>"
...
var StatisticsComponent = /** @class */ (function () {
    function StatisticsComponent(heroService) {
        this.heroService = heroService;
        this.title = 'Statistics';
        this.months = ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec'];
        this.colors = ['Red', 'Blue', 'Green', 'Yellow', 'Orange', 'Purple', 'Black', 'brown', 'aqua', 'gray', 'crimson', 'violet'];
    }
    StatisticsComponent.prototype.ngOnInit = function () {
        this.loadChart();
    };
    StatisticsComponent.prototype.loadChart = function () {
        var _this = this;
        var chartsData = [];
        var index = 0;
        this.heroService.getHeroes()
            ...
            heroes.forEach(function (hero) {
                if (hero.stats.crimesSolvedStats) {
                    var statsData = hero.stats.crimesSolvedStats.lineData;
                    var chartObj = {
                        label: hero.name,
                        data: statsData,
            ...
            _this.drawBarChart(chartsData);
        });
    };
    StatisticsComponent.prototype.getRandomColor = function () {
        var color = 'rgb(' + (Math.floor(Math.random() * 256)) + ','
            + (Math.floor(Math.random() * 256)) + ',' + (Math.floor(Math.random() * 256)) + ')';
        return color;
    };
    StatisticsComponent.prototype.drawBarChart = function (chartsData) {
        this.barChart = new chart_js__WEBPACK_IMPORTED_MODULE_1__["Chart"]('barCanvas', {
            type: 'bar',
            data: {
                labels: this.months,
                datasets: chartsData
...
module.exports = __webpack_require__(/*! D:\Software_Tutorials\angular6\angular-heroes\src\main.ts */"./src/main.ts");
