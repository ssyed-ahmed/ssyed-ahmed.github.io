...
var routes = [
    ...
    { path: 'heroes/:id/:fromState', component: src_app_hero_detail_hero_detail_component__WEBPACK_IMPORTED_MODULE_4__["HeroDetailComponent"] },
...
module.exports = "<nav class=\"navbar navbar-dark bg-dark\">\r\n    <a class=\"navbar-brand\" href=\"#\">\r\n      <img src=\"../assets/icon.png\" width=\"50\" height=\"50\" alt=\"\">\r\n      <div class=\"main-title\">\r\n          Superheroes\r\n        </div>\r\n    </a>\r\n</nav>\r\n\r\n<div class=\"container-fluid\">\r\n  <div class=\"row\">\r\n      <div class=\"col-sm-2 no-padding\">\r\n        <div class=\"section\">\r\n          <div class=\"section-header\">\r\n            <div class=\"row\">\r\n              <div class=\"col-sm-9 section-title\">\r\n                Menu\r\n              </div>\r\n              <div class=\"col-sm-3\">\r\n                <i class=\"fas fa-sync refresh-style\" (click)=\"restoreHeroes()\"></i>\r\n              </div>\r\n            </div>\r\n          </div>\r\n          <div class=\"section-body\">\r\n            <div class=\"nav flex-column nav-pills\" id=\"v-pills-tab\" role=\"tablist\" aria-orientation=\"vertical\">\r\n              <a class=\"nav-link\" id=\"v-pills-home-tab\" data-toggle=\"pill\" href=\"#v-pills-home\" role=\"tab\" aria-controls=\"v-pills-home\" aria-selected=\"true\" routerLink=\"/dashboard\" routerLinkActive=\"active\">Dashboard</a>\r\n              <a class=\"nav-link\" id=\"v-pills-profile-tab\" data-toggle=\"pill\" href=\"#v-pills-profile\" role=\"tab\" aria-controls=\"v-pills-profile\" aria-selected=\"false\" routerLink=\"/heroes\" routerLinkActive=\"active\">Heroes</a>\r\n              <a class=\"nav-link\" id=\"v-pills-settings-tab\" data-toggle=\"pill\" href=\"#v-pills-settings\" role=\"tab\" aria-controls=\"v-pills-settings\" aria-selected=\"false\" routerLink=\"/logs\" routerLinkActive=\"active\">Logs</a>\r\n              <a class=\"nav-link\" id=\"v-pills-settings-tab\" data-toggle=\"pill\" href=\"#v-pills-settings\" role=\"tab\" aria-controls=\"v-pills-settings\" aria-selected=\"false\" routerLink=\"/statistics\" routerLinkActive=\"active\">Statistics</a>\r\n            </div>\r\n          </div>\r\n        </div>        \r\n      </div>\r\n      <div class=\"col-sm-10 no-right-padding\">        \r\n        <router-outlet></router-outlet>        \r\n      </div>\r\n  </div>\r\n</div>\r\n"
...
var Hero = /** @class */ (function () {
    function Hero(id, name, icon, description, sex) {
        this.id = id;
        this.name = name;
        this.icon = icon;
...
var HeroesComponent = /** @class */ (function () {
    function HeroesComponent(heroService, router, communicationService, route) {
        ...
        this.heroModel = new _hero__WEBPACK_IMPORTED_MODULE_1__["Hero"](1, '', 'default', '', 'Male');
        // Subscribe to the app component messages
        this.subscription = this.communicationService.getMessage().subscribe(function (message) {
            if (message.text === 'restore heroes') {
                _this.restoreHeroes();
    ...
    HeroesComponent.prototype.addHero = function () {
        var _this = this;
        var newHero = new _hero__WEBPACK_IMPORTED_MODULE_1__["Hero"](this.heroModel.id, this.heroModel.name, 'default', this.heroModel.description, this.heroModel.sex);
        this.heroService.addHero(newHero)
            .subscribe(function (hero) {
            _this.heroes.push(hero);
            // Reset the heroModel
            _this.heroModel = new _hero__WEBPACK_IMPORTED_MODULE_1__["Hero"](1, '', 'default', '', 'Male');
        });
    };
...
var InMemoryDataService = /** @class */ (function () {
    ...
    InMemoryDataService.prototype.createDb = function () {
        var heroes = [
            new _hero__WEBPACK_IMPORTED_MODULE_1__["Hero"](11, 'Antman', 'antman', 'This is ant man.', 'Male'),
            new _hero__WEBPACK_IMPORTED_MODULE_1__["Hero"](12, 'Batman', 'batman', 'This is bat man.', 'Male'),
            new _hero__WEBPACK_IMPORTED_MODULE_1__["Hero"](13, 'Hulk', 'hulk', 'This is hulk.', 'Male'),
            new _hero__WEBPACK_IMPORTED_MODULE_1__["Hero"](14, 'Ironman', 'ironman', 'This is iron man.', 'Male'),
            new _hero__WEBPACK_IMPORTED_MODULE_1__["Hero"](15, 'Spiderman', 'spiderman', 'This is spider man.', 'Male'),
            new _hero__WEBPACK_IMPORTED_MODULE_1__["Hero"](16, 'Superman', 'superman', 'This is super man.', 'Male'),
            new _hero__WEBPACK_IMPORTED_MODULE_1__["Hero"](17, 'Wonderwoman', 'wonderwoman', 'This is wonder woman.', 'Female'),
            new _hero__WEBPACK_IMPORTED_MODULE_1__["Hero"](18, 'Green lantern', 'greenlantern', 'This is green lantern.', 'Male'),
            new _hero__WEBPACK_IMPORTED_MODULE_1__["Hero"](19, 'Mocking bird', 'mockingbird', 'This is mocking bird.', 'Female'),
            new _hero__WEBPACK_IMPORTED_MODULE_1__["Hero"](20, 'Black widow', 'blackwidow', 'This is black widow.', 'Female'),
            new _hero__WEBPACK_IMPORTED_MODULE_1__["Hero"](21, 'New hero', 'default', 'This is default hero.', 'Male')
        ];
...
var HEROES = [
    new _hero__WEBPACK_IMPORTED_MODULE_0__["Hero"](11, 'Antman', 'antman', 'This is ant man.', 'Male'),
    new _hero__WEBPACK_IMPORTED_MODULE_0__["Hero"](12, 'Batman', 'batman', 'This is bat man.', 'Male'),
    new _hero__WEBPACK_IMPORTED_MODULE_0__["Hero"](13, 'Hulk', 'hulk', 'This is hulk.', 'Male'),
    new _hero__WEBPACK_IMPORTED_MODULE_0__["Hero"](14, 'Ironman', 'ironman', 'This is iron man.', 'Male'),
    new _hero__WEBPACK_IMPORTED_MODULE_0__["Hero"](15, 'Spiderman', 'spiderman', 'This is spider man.', 'Male'),
    new _hero__WEBPACK_IMPORTED_MODULE_0__["Hero"](16, 'Superman', 'superman', 'This is super man.', 'Male'),
    new _hero__WEBPACK_IMPORTED_MODULE_0__["Hero"](17, 'Wonderwoman', 'wonderwoman', 'This is wonder woman.', 'Female'),
    new _hero__WEBPACK_IMPORTED_MODULE_0__["Hero"](18, 'Green lantern', 'greenlantern', 'This is green lantern.', 'Male'),
    new _hero__WEBPACK_IMPORTED_MODULE_0__["Hero"](19, 'Mocking bird', 'mockingbird', 'This is mocking bird.', 'Female'),
    new _hero__WEBPACK_IMPORTED_MODULE_0__["Hero"](20, 'Black widow', 'blackwidow', 'This is black widow.', 'Female'),
    new _hero__WEBPACK_IMPORTED_MODULE_0__["Hero"](21, 'New hero', 'default', 'This is default hero.', 'Male')
];
